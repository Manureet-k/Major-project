...
def getPage1():
    ...
    # Adding Input Fields
    input_fields = ("Name", "Crimes Done", "Profile Image")
...
######################################## Home Page ####################################
tk.Label(pages[0], text="CRIMINAL FACE IDENTIFICATION SYSTEM", fg="white", bg="black",
      font="Arial 25 bold", pady=30).pack()

#logo = tk.PhotoImage(file = r"/home/ghost/Facial-Recognition-For-Criminal-Detection\img\logo2.png")
logo = tk.PhotoImage(file = "peps.png")
tk.Label(pages[0], image=logo, bg="YELLOW").pack(side='top')
...
tk.Button(btn_frame, text="Recognition", command=getPage2)
